...
public class ArrayTest1 {
    ...
    public static void main(String[] args) {
        ...
        //배열이란 ? 연관된 데이터 탕비을 한번에 모아서 통으로 관리하기 위해 사용

        //배열을 선언하는 문법
        //규칙 1.
        //배열은 반드시 먼저 몇개의 데이터가 들어갈지 정해 쓸 수 있다.

        //int[] numbers;//배열의 선언
        //numbers = new int[3];// 4 바이트 네모칸 3개 선언 3개 초기화

        int[] nubers = new int[3]; // 데이터 타입에 대괄호 문법 허용
        int intBoxs[] = new int[5];// 변수 뒤 대괄호 문법 허용
        ...
        //[][][][][][]
        // 굳이 네모칸 선언 안해도됨 위 문법형식은

        //문제1
        //5개의 크기를 가지는 double 타입 배열을 선언하시오
        //배열에 이름은 마음대로 작성하시오.

        double[] doubles = new double[5];//길이를 정해야한다.
        doubles[0]=1.0;
        doubles[1]=1.1;
        doubles[2]=1.2;
        doubles[3]=1.3;
        doubles[4]=1.4;
        //중요 !!1-모든 프로그래밍 언어에 인덱스는 0부터 시작한다.
